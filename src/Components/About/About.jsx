...
export default function About() {
    return (
        <div className="about">
            <h1>
                <label style={{ color: 'rgba(179, 0, 0, 1)' }}>VALUE.</label><span>ON</span><label style={{color: 'rgb(255, 157, 0)'}}>DEMAND</label>
            </h1>
            <Heading title='We are Here to Stay!' description='The best quality in technology' />
